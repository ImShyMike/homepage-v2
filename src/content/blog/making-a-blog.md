---
title: Making a blog
description: A workshop on how to make a blog with Astro and Markdown
pubDate: Dec 24 2025
tags: ['workshop', 'astro', 'markdown', 'blog']
...
![astro dev server](../../assets/blog/making-a-blog/setup.png)
...
You can make stuff **bold**, _italic_, or even ~~strikethrough~~ like in regular markdown!
...
![homepage](../../assets/blog/making-a-blog/homepage.png)
...
<div class="post-page page-shell">
    <article class="post">
        ...
        <header>
            ...
            {heroImage && <Image src={heroImage} format="webp" alt={title} class="hero" />}
            <p class="date">
...
![blog post](../../assets/blog/making-a-blog/workshop-banner.png)
...
![blog posts list](../../assets/blog/making-a-blog/posts.png)
...
![cloudflare pages create](../../assets/blog/making-a-blog/cf-pages.png)
...
![cloudflare pages deployed](../../assets/blog/making-a-blog/success.png)
